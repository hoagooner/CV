    ...
    <div className="row"
        ...
        <div className="col-sm-7">
            <div className="row">
                ...
                <div class="col-sm-3" >
                    {/* <select class="form-control NotStarted">
                        <option value={props.task.status}>{props.task.status}</option>
                        {statuses.filter(name => !name.includes(props.task.status)).map(filteredName => (
                ...
                <div class="col-sm-3" >
                    {/* <select class="form-control">
                        <option value={props.task.priority}>{props.task.priority}</option>
                        {priorities.filter(name => !name.includes(props.task.priority)).map(filteredName => (
                            <option value={filteredName}>{filteredName}</option>
                        ))}
                    </select> */}
